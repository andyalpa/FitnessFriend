...
export const BackendURL = () => (
	<div className="mt-5 pt-5 w-50 mx-auto">
		<h2>Missing NEXT_PUBLIC_BACKEND_URL env variable</h2>
		...
		<p>There's one variable called <Dark>NEXT_PUBLIC_BACKEND_URL</Dark> that needs to be manually set by yourself.</p>
		<ol>
			...
			<li>Add a new variable NEXT_PUBLIC_BACKEND_URL=<Dark>your api host</Dark></li>
